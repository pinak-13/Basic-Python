#WAP to accept 5 numbers in 5 different var and check maximum value and print using simple if
...
if p2>p1 and p2>p3 and p2>p4 and p2>p5:
    print("p2 is greater")
if p3>p2 and p3>p1 and p3>p4 and p3>p5:
    print("p3 is greater")
if p4>p2 and p4>p3 and p4>p1 and p5>p1:
    print("p4 is greater")
